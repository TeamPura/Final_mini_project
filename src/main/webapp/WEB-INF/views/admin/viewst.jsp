...
<form class="form-horizontal" action="editst/${student.userId}" method="post">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="userId" name="userId" class="form-control input-md" type="text" value="${student.userId}" disabled>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="password" name="password" class="form-control input-md" type="text" value="${student.password}">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="lname" name="lname" class="form-control input-md" type="text" value="${student.lname}">    
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="fname" name="fname" class="form-control input-md" type="text" value="${student.fname}">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="mname" name="mname" class="form-control input-md" type="text" value="${student.mname}">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="bday" name="bday" class="form-control input-md" type="text" value="${student.bday}">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="address" name="address" class="form-control input-md" type="text" value="${student.address}">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="emailAddress" name="emailAddress" class="form-control input-md" type="text">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="courseId" name="courseId" class="form-control">
      ...
      <option value="${courseValue.courseId}" name="courseId" ${courseValue.courseId == coursedid ? 'selected="selected"' : ''}>${courseValue.courseDesc}</option>
     </c:forEach>
    </select>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="yearLevel" name="yearLevelId" class="form-control">
      ...
      <option value="${yearLevelValue.yearLevelId}" name="yearLevelId" ${yearLevelValue.yearLevelId == yearleveldid ? 'selected="selected"' : ''}>${yearLevelValue.yearLevelDesc}</option>
     </c:forEach>
    </select>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="semesterId" name="semesterId" class="form-control">
      ...
      <option value="${semesterValue.semesterId}" name="semesterId" ${semesterValue.semesterId == semesterdid ? 'selected="selected"' : ''}>${semesterValue.semesterDesc}</option>
     </c:forEach>
    </select>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="prospectusId" name="prospectusId" class="form-control">
      ...
      <option value="${prospectusValue.prospectusId}" name="prospectusId" ${prospectusValue.prospectusId == prospectusdid ? 'selected="selected"' : ''}>${prospectusValue.prospectusDesc}</option>
     </c:forEach>
    </select>
  </div>
</div>
