...
<head>
	...
	<title>Student | Study Load</title>
                	...
                	<div class="row">
                		...
                		<div class="box box-solid box-primary">
                        	<div class="box-header">
                            	...
                            	<h3 class="box-title">Study Load</h3>
                            </div><!-- /.box-header -->
	...
	<!-- AdminLTE App -->
        ...
        <script>
			$( document ).ready(function() {
				...
				$('#enrollment_plot_body').load('studyLoadSchedule #enrollment_plot', function(){
